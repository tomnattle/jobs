...
$_config = [
    'local' => [
        'urls' => [
            'raw-data-export' => function ($params) {
                //email 导出活动原始数据
                $url = "http://task2.wpcn.dev/rest/v2/" . $params['projectId'] . "/raw-data/" . $params['taskId'];
            ...
            'domain-export' => function ($params) {
                //email 导出域名列表
                if(!$params['taskId']){
                    $url = "http://task2.wpcn.dev/rest/v2/domain-report/count-sum";
                    ...
                    return "http://task2.wpcn.dev/rest/v2/domain-report/" . $params['taskId'] . "?top=99999&page=" . $params['page'] . "&page_size=" . $params['page_size'];
                }
            },
            'task-report-export' => function ($params) {
                //email 活动发送报告
                $url = "http://task2.wpcn.dev/rest/v2/tasks";
            ...
            'sms-reply-export' => function ($params) {
                ...
                $url = "http://sms-task.dev.dmayun.com/replyDown";
            ...
            'sms-click-export' => function ($params) {
                ...
                $params['date_start'] = strtotime($params['date_start']);
                $params['date_end'] = strtotime($params['date_end']);
                $url = "http://sms-task.dev.dmayun.com/sendClickReportDown";
            ...
            'sms-report-export' => function ($params) {
                ...
                $params['date_start'] = strtotime($params['date_start']);
                $params['date_end'] = strtotime($params['date_end']);
                $url = "http://sms-task.dev.dmayun.com/reportDown";
        ...
        'page-size' => 500,
        'ufile' => [
            'upload-post' => 'http://ufile.dev.dmayun.com/rest/v1/uploadimg'
        ],
    ...
    'beta' => [
        'urls' => [
            'raw-data-export' => function ($params) {
                //email 导出活动原始数据
                $url = "http://10.10.49.130:9099/rest/v2/" . $params['projectId'] . "/raw-data/" . $params['taskId'];
                return $url .= "?actions=" . implode(',', $params['actions']) . "&fields=" . implode(',', $params['fields']) . "&date_start=" . $params['date_start'] . "&date_end=" . $params['date_end'] . "&page=" . $params['page'] . "&page_size=" . $params['page_size'] ;   
            },
            'domain-export' => function ($params) {
                //email 导出域名列表
                if(!$params['taskId']){
                    $url = "http://10.10.49.130:9099/rest/v2/domain-report/count-sum";
                    return $url .= "?top=99999&projectId=" . $params['projectId'] . "&date_start=" . $params['time-span'][0] . "&date_end=" .$params['time-span'][1] . "&page=" . $params['page'] . "&page_size=" . $params['page_size'];
                }else{
                    return "http://10.10.49.130:9099/rest/v2/domain-report/" . $params['taskId'] . "?top=99999&page=" . $params['page'] . "&page_size=" . $params['page_size'];
                }
            },
            'task-report-export' => function ($params) {
                //email 活动发送报告
                $url = "http://10.10.49.130:9099/rest/v2/tasks";
                return $url .= "?show_task_result=1&type=mail-send&send_state=finished&projectId=" . $params['projectId'] . "&page=" . $params['page'] . "&page_size=" . $params['page_size'];
            },
            'sms-reply-export' => function ($params) {
                //sms 短信上下行
        ...
        'page-size' => 500,
        'ufile' => [
            'upload-post' => 'http://10.10.49.130:9086/rest/v1/uploadimg'
        ],
        'file_path' => function ($projectId, $taskId) {
            return ROOT . "/data/" . $projectId . "/" . $taskId . "/";
        },
        ...
        'urls' => [
            ...
            'domain-export' => function ($params) {
                ...
                if(!$params['taskId']){
                    ...
                    return "http://10.10.49.130:9099/rest/v2/domain-report/" . $params['taskId'] . "?page=" . $params['page'] . "&page_size=" . $params['page_size'];
                }
            },
            'task-report-export' => function ($params) {
                //email 活动发送报告
