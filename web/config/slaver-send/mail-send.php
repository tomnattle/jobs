...
$_config = [
    ...
    'dev' => [
        ...
        'downloader_uri' => function ($accessToken, $projectId, $fileName) {
            return 'http://upload2.dev.dmayun.com/?access-token=server-side&projectId=' . $projectId . '&filename=' . $fileName;
        },
        'import_api' => function ($projectId) {
            return 'http://contact2.wpcn.dev/rest/v2/' . $projectId . '/users';
        }
    ...
    'beta' => [
        ...
        'json_path' => function ($projectId, $taskId) {
         ...
         /**
        'upload_uri' => function () {
            return "http://10.10.62.202:8667";
        },
        'downloader_uri' => function ($accessToken, $projectId, $fileName) {
            return 'http://10.10.62.202:8667/?access-token=server-side&projectId=' . $projectId . '&filename=' . $fileName;
        },
        'import_api' => function ($projectId) {
