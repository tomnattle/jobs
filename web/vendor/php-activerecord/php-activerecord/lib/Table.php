...
class Table
{
    ...
    /**
     * Name of the sequence for this table (optional).
     * Defaults to {$table}_seq
     */
    public $sequence;
     ...
     *
     * @param $models array
     *            found modesl for this table
     * @param $attrs array
     *            of attrs from $models
    ...
    /**
     * Retrieve a relationship object for this table.
     * Strict as true will throw an error
