...
class Request
{
    ...
    public $uri, $method = Http::GET, $headers = array(), $raw_headers = '', $strict_ssl = false, $content_type, $expected_type, $additional_curl_opts = array(), $auto_parse = true, $serialize_payload_method = self::SERIALIZE_PAYLOAD_SMART, $username, $password, $serialized_payload, $payload, $parse_callback, $error_callback, $send_callback, $follow_redirects = false, $max_redirects = self::MAX_REDIRECTS_DEFAULT, $payload_serializers = array();
     ...
     *
     * @param array $attrs
     *            hash of initial attribute values
     */
     ...
     * class from a template Request object.
     * Simply construct a
     ...
     *            Name of attribute (e.g. mime, headers)
     ...
     *            seconds to timeout the HTTP call
     * @return Request
     */
     ...
     *
     * @param bool|int $follow
     *            follow or not to follow or maximal number of redirects
     * @return Request
     */
     ...
     *            currently, sets the sends AND expects mime type although this
     ...
     *
     * @param string $mime
     *            mime type to use for content type and expected return type
     * @return Request
     */
    ...
    /**
     * Set the method.
     * Shouldn't be called often as the preferred syntax
     ...
     *            Hostname or address of the proxy
     * @param int $proxy_port
     *            Port of the proxy. Default 80
     * @param string $auth_type
     *            Authentication type or null. Accepted values are CURLAUTH_BASIC, CURLAUTH_NTLM. Default null, no authentication
     * @param string $auth_username
     *            Authentication username. Default null
     * @param string $auth_password
     *            Authentication password. Default null
     * @return Request
     */
    public function useProxy($proxy_host, $proxy_port = 80, $auth_type = null, $auth_username = null, $auth_password = null, $proxy_type = Proxy::HTTP)
    {
        ...
        if (in_array($auth_type, array(
            ...
            $this->addOnCurlOption(CURLOPT_PROXYAUTH, $auth_type)->addOnCurlOption(CURLOPT_PROXYUSERPWD, "{$auth_username}:{$auth_password}");
        }
        return $this;
    }
    ...
    /**
     *
     * @param bool $auto_parse
     *            perform automatic "smart"
    ...
    /**
     * Callback called to handle HTTP errors.
     * When nothing is set, defaults
     ...
     * @param array $args
     *            in this case, there should only ever be 1 argument provided
    ...
    /**
     * Factory style constructor works nicer for chaining.
     * This
