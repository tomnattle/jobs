...
class Swift_Mime_SimpleMessageTest extends Swift_Mime_MimePartTest
{
    ...
    public function testDateIsReturnedFromHeader()
    {
        ...
        $message = $this->_createMessage($this->_createHeaderSet(array(
            'Date' => $date
    ...
    public function testSenderIsReturnedFromHeader()
    {
         ...
         * -- RFC 2822, 3.6.2.
         */
        $sender = $this->_createHeader('Sender', array(
            'sender@domain' => 'Name'
        ));
        $message = $this->_createMessage($this->_createHeaderSet(array(
            'Sender' => $sender
    ...
    public function testFromIsReturnedFromHeader()
    {
         ...
         * -- RFC 2822, 3.6.2.
         */
        $from = $this->_createHeader('From', array(
            'from@domain' => 'Name'
        ));
        $message = $this->_createMessage($this->_createHeaderSet(array(
            'From' => $from
    ...
    public function testReplyToIsReturnedFromHeader()
    {
         ...
         * -- RFC 2822, 3.6.2.
         */
        $reply = $this->_createHeader('Reply-To', array(
            'reply@domain' => 'Name'
        ));
        $message = $this->_createMessage($this->_createHeaderSet(array(
            'Reply-To' => $reply
    ...
    {
        $replyTo = $this->_createHeader('Reply-To', array(
            'from@domain' => 'Name'
        ), array(), false);
    ...
    public function testToIsReturnedFromHeader()
    {
         ...
         * -- RFC 2822, 3.6.3.
         */
        $to = $this->_createHeader('To', array(
            'to@domain' => 'Name'
        ));
        $message = $this->_createMessage($this->_createHeaderSet(array(
            'To' => $to
    ...
    public function testCcIsReturnedFromHeader()
    {
         ...
         * -- RFC 2822, 3.6.3.
         */
        $cc = $this->_createHeader('Cc', array(
            'cc@domain' => 'Name'
        ));
        $message = $this->_createMessage($this->_createHeaderSet(array(
            'Cc' => $cc
    ...
    public function testBccIsReturnedFromHeader()
    {
         ...
         * -- RFC 2822, 3.6.3.
         */
        $bcc = $this->_createHeader('Bcc', array(
            'bcc@domain' => 'Name'
        ));
        $message = $this->_createMessage($this->_createHeaderSet(array(
            'Bcc' => $bcc
    ...
    {
        $rcpt = $this->_createHeader('Disposition-Notification-To', array(
