...
$_config = [
    'local' => [
        ...
        'upload_uri' => function ($token) {
            return "http://upload.dev.*.com" . "/index.php?access-token=" . $token; //return "http://upload.*.dev";
        },
        'downloader_uri' => function ( $projectId, $fileName) {
            return 'http://upload.dev.*.com?projectId=' . $projectId . '&filename=' . $fileName;
        },
    ...
    'dev' => [
        ...
        'upload_uri' => function ($token) {
            return "http://upload2.dev.*.com" . "/index.php?access-token=" . $token; //return "http://upload.*.dev";
        },
        'downloader_uri' => function ( $projectId, $fileName) {
            return $fileName;
        },
    ...
    'beta' => [
        ...
        'upload_uri' => function ($token) {
            return "http://*.*.2.194:8776" . "/index.php?access-token=" . $token; //return "http://upload.*.dev";
        },
        'downloader_uri' => function ( $projectId, $fileName) {
            return $fileName;
        },
