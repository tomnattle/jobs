...
abstract class Connection
{
     ...
     *
     * @param string $connection_string_or_connection_name
     *            A database connection string (ex. mysql://user:pass@host[:port]/dbname)
    ...
    /**
     * Class Connection is a singleton.
     * Access it via instance().
     *
     * @param array $info
     *            Array containing URL parts
     * @return Connection
     */
    protected $host = '';
    ...
    protected function __construct($info)
    {
        try {
            ...
            if ($info->host[0] != '/') {
                $this->host = "host=$info->host";
                
                if (isset($info->port))
                    $this->host .= ";port=$info->port";
            } else
                $this->host = "unix_socket=$info->host";
     ...
     *            Optional name of a sequence to use
     * @return int
     */
     ...
     *            Closure that will be passed the fetched results.
     */
     ...
     *            Name of column sequence is for
     ...
     *
     * @param string $string
     *            A datetime in the form accepted by date_create()
     * @return DateTime
     */
     ...
     *
     * @internal @returns boolean (FALSE by default)
     */
