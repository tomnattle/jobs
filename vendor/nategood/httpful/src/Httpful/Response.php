...
class Response
{
    ...
    public $body, $raw_body, $headers, $raw_headers, $request, $code = 0, $content_type, $parent_type, $charset, $meta_data, $is_mime_vendor_specific = false, $is_mime_personal = false;
